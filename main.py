...
# give first frame of live video or simple video for edge detection
while True:
...
perspective = cv2.imread("image_aruco/perspective.jpg")

# create file object for saving the logs
#f = open(f'test_log/log{num}','w')

# a loop for giving frame by frame from camera
while True:
